...
<div id="content">
    <div id="content-header">
      ...
      <a href="{{ route('products.index') }}">Products</a> <a href="#" class="current">Add Product Attributes</a> </div>
      ...
      <div class="row-fluid">
        <div class="span12">
          <div class="widget-box">
            ...
            <form class="form-horizontal" method="post" action="{{ route('add.attribute', $productDetails->id) }}" name="add_attribute" id="add_attribute" enctype="multipart/form-data">
              @csrf  
